...
using Histogram = Nethermind.Monitoring.Model.Histogram;
...
namespace Nethermind.Synchronization
{
    public static class Metrics
    {
        ...
        [Description("Sync dispatch latency")]
        public static Histogram SyncDispatchLatency = Histogram.NewLatencyHistogram(nameof(SyncDispatchLatency), "feed_type", "status");

        [Description("Sync response latency")]
        public static Histogram SyncResponseLatency = Histogram.NewLatencyHistogram(nameof(SyncResponseLatency), "feed_type", "status");
    }
}
