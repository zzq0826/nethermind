...
namespace Nethermind.Synchronization
{
    public class Synchronizer : ISynchronizer
    {
        ...
        {
            new SyncDbTuner(_syncConfig, _snapSyncFeed, _verkleSyncFeed, _bodiesFeed, _receiptsFeed, _dbProvider.StateDb, _dbProvider.CodeDb,
        ...
        private void StartVerkleSyncComponents()
        {
            ...
            VerkleSyncDispatcher dispatcher = new(_verkleSyncFeed!, _syncPeerPool, new VerkleSyncAllocationStrategyFactory(), _logManager);
