...
public class VerkleSyncDispatcher: SyncDispatcher<VerkleSyncBatch>
{
    public VerkleSyncDispatcher(ISyncFeed<VerkleSyncBatch>? syncFeed, ISyncPeerPool? syncPeerPool, IPeerAllocationStrategyFactory<VerkleSyncBatch>? peerAllocationStrategy, ILogManager? logManager)
        : base(syncFeed, syncPeerPool, peerAllocationStrategy, logManager)
    {
    }

    protected override async Task Dispatch(PeerInfo peerInfo, VerkleSyncBatch batch,
