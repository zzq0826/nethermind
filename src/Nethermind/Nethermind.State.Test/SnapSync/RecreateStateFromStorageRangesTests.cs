...
namespace Nethermind.Store.Test
{
    ...
    public class RecreateStateFromStorageRangesTests
    {
        ...
        public void RecreateStorageStateFromOneRangeWithNonExistenceProof()
        {
            ...
            AccountProofCollector accountProofCollector = new(TestItem.Tree.AccountAddress0.CreateByteArray, new Keccak[] { Keccak.Zero, TestItem.Tree.SlotsWithPaths[5].Path });
        ...
        public void RecreateAccountStateFromOneRangeWithExistenceProof()
        {
            ...
            AccountProofCollector accountProofCollector = new(TestItem.Tree.AccountAddress0.CreateByteArray, new Keccak[] { TestItem.Tree.SlotsWithPaths[0].Path, TestItem.Tree.SlotsWithPaths[5].Path });
            _inputStateTree!.Accept(accountProofCollector, _inputStateTree.RootHash);
            var proof = accountProofCollector.BuildResult();
        ...
        public void RecreateAccountStateFromMultipleRange()
        {
            ...
            AccountProofCollector accountProofCollector = new(TestItem.Tree.AccountAddress0.CreateByteArray, new Keccak[] { Keccak.Zero, TestItem.Tree.SlotsWithPaths[1].Path });
            _inputStateTree!.Accept(accountProofCollector, _inputStateTree.RootHash);
            var proof = accountProofCollector.BuildResult();
            ...
            accountProofCollector = new(TestItem.Tree.AccountAddress0.CreateByteArray, new Keccak[] { TestItem.Tree.SlotsWithPaths[2].Path, TestItem.Tree.SlotsWithPaths[3].Path });
            _inputStateTree!.Accept(accountProofCollector, _inputStateTree.RootHash);
            ...
            accountProofCollector = new(TestItem.Tree.AccountAddress0.CreateByteArray, new Keccak[] { TestItem.Tree.SlotsWithPaths[4].Path, TestItem.Tree.SlotsWithPaths[5].Path });
            _inputStateTree!.Accept(accountProofCollector, _inputStateTree.RootHash);
            proof = accountProofCollector.BuildResult();
