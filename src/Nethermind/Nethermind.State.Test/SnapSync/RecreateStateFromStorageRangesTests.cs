...
namespace Nethermind.Store.Test
{
    ...
    public class RecreateStateFromStorageRangesTests
    {
        ...
        public void RecreateStorageStateFromOneRangeWithNonExistenceProof()
        {
            ...
            var result = snapProvider.AddStorageRange(1, null, rootHash, Keccak.Zero, null, TestItem.Tree.SlotsWithPaths, proof!.StorageProofs![0].Proof!.Concat(proof!.StorageProofs![1].Proof!).ToArray());
        ...
        public void RecreateStorageStateFromOneRangeWithoutProof()
        {
            ...
            ProgressTracker progressTracker = new(null, dbProvider.GetDb<IDb>(DbNames.State), LimboLogs.Instance);
            SnapProvider snapProvider = new(progressTracker, dbProvider, LimboLogs.Instance);
            var result = snapProvider.AddStorageRange(1, null, rootHash, TestItem.Tree.SlotsWithPaths[0].Path, null, TestItem.Tree.SlotsWithPaths);
        ...
        public void RecreateAccountStateFromMultipleRange()
        {
            ...
            var result1 = snapProvider.AddStorageRange(1, null, rootHash, Keccak.Zero, null, TestItem.Tree.SlotsWithPaths[0..2], proof!.StorageProofs![0].Proof!.Concat(proof!.StorageProofs![1].Proof!).ToArray());
            ...
            var result2 = snapProvider.AddStorageRange(1, null, rootHash, TestItem.Tree.SlotsWithPaths[2].Path, null, TestItem.Tree.SlotsWithPaths[2..4], proof!.StorageProofs![0].Proof!.Concat(proof!.StorageProofs![1].Proof!).ToArray());
            ...
            var result3 = snapProvider.AddStorageRange(1, null, rootHash, TestItem.Tree.SlotsWithPaths[4].Path, null, TestItem.Tree.SlotsWithPaths[4..6], proof!.StorageProofs![0].Proof!.Concat(proof!.StorageProofs![1].Proof!).ToArray());
        ...
        public void MissingAccountFromRange()
        {
            ...
            var result2 = snapProvider.AddStorageRange(1, null, rootHash, TestItem.Tree.SlotsWithPaths[2].Path, null, TestItem.Tree.SlotsWithPaths[3..4], proof!.StorageProofs![0].Proof!.Concat(proof!.StorageProofs![1].Proof!).ToArray());
