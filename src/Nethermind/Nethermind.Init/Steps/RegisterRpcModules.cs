...
namespace Nethermind.Init.Steps
{
    ...
    public class RegisterRpcModules : IStep
    {
        ...
        public virtual async Task Execute(CancellationToken cancellationToken)
        {
            ...
            {
                true => new TraceModuleFactory(_api.DbProvider, _api.BlockTree, _api.ReadOnlyVerkleTrieStore!, rpcConfig, _api.BlockPreprocessor, _api.RewardCalculatorSource, _api.ReceiptStorage, _api.SpecProvider, _api.PoSSwitcher, _api.LogManager),
                false => new TraceModuleFactory(_api.DbProvider, _api.BlockTree, _api.ReadOnlyTrieStore!, rpcConfig, _api.BlockPreprocessor, _api.RewardCalculatorSource, _api.ReceiptStorage, _api.SpecProvider, _api.PoSSwitcher, _api.LogManager),
            };
