...
public class TestVerkleBlockchain : IDisposable
{
    ...
    protected TestVerkleBlockchain()
    {
    }
    ...
    protected virtual async Task<TestVerkleBlockchain> Build(ISpecProvider? specProvider = null, UInt256? initialValues = null, bool addBlockOnStart = true)
    {
        ...
        WorldStateManager = new VerkleWorldStateManager(State, TrieStore, DbProvider, LimboLogs.Instance);
