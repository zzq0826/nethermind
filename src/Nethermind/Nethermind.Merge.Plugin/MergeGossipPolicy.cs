...
namespace Nethermind.Merge.Plugin
{
    public class MergeGossipPolicy : IGossipPolicy
    {
        ...
        public bool ShouldDiscardBlocks => _poSSwitcher.TransitionFinished ||
                                           (_blockCacheService.FinalizedHash != null && _blockCacheService.FinalizedHash != Keccak.Zero);  /* _blockCacheService.FinalizedHash != Keccak.Zero - this condition was added for edge case situation.
