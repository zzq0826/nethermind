...
public interface ITxPoolConfig : IConfig
{
    ...
    [ConfigItem(DefaultValue = "1", Description = "Minimal percentage of the current base fee which must be surpassed by MaxFeePerGas for the transaction to be broadcasted.")]
