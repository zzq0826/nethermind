...
namespace Nethermind.Network.Test
{
    public static class NetTestVectors
    {
        ...
        public static (EncryptionSecrets A, EncryptionSecrets B) GetSecretsPair()
        {
            ...
            handshakeA.InitiatorNonce = TestItem.KeccakA.CreateByteArray;
            handshakeA.RecipientNonce = TestItem.KeccakB.CreateByteArray;
            ...
            handshakeB.InitiatorNonce = TestItem.KeccakA.CreateByteArray;
            handshakeB.RecipientNonce = TestItem.KeccakB.CreateByteArray;
