...
namespace Nethermind.Network.P2P.Subprotocols.Eth
{
    public interface IPooledTxsRequestor
    {
        ...
        IReadOnlyList<TxAnnounceData> RequestTransactionsEth68(Action<V66.Messages.GetPooledTransactionsMessage> send, IReadOnlyList<Hash256> hashes, IReadOnlyList<int> sizes, IReadOnlyList<byte> types);
    }
}
