...
namespace Nethermind.Synchronization.Test.FastSync
{
    ...
    public class StateSyncFeedTests : StateSyncFeedTestsBase
    {
        ...
        public async Task Big_test((string Name, Action<StateTree, ITrieStore, IDb> SetupTree) testCase)
        {
            ...
            dbContext.RemoteCodeDb[Keccak.Compute(TrieScenarios.Code0).CreateByteArray] = TrieScenarios.Code0;
            dbContext.RemoteCodeDb[Keccak.Compute(TrieScenarios.Code1).CreateByteArray] = TrieScenarios.Code1;
            dbContext.RemoteCodeDb[Keccak.Compute(TrieScenarios.Code2).CreateByteArray] = TrieScenarios.Code2;
            dbContext.RemoteCodeDb[Keccak.Compute(TrieScenarios.Code3).CreateByteArray] = TrieScenarios.Code3;
