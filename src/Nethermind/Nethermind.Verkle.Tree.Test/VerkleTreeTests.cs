...
public class VerkleTreeTests
{
    ...
    private readonly Hash256 _keyVersion = (Hash256)new byte[]
    {
        121, 85, 7, 198, 131, 230, 143, 90, 165, 129, 173, 81, 186, 89, 19, 191, 13, 107, 197, 120, 243, 229, 224,
        183, 72, 25, 6, 8, 210, 159, 31, 0,
    };

    private readonly Hash256 _keyBalance = (Hash256)new byte[]
    {
        121, 85, 7, 198, 131, 230, 143, 90, 165, 129, 173, 81, 186, 89, 19, 191, 13, 107, 197, 120, 243, 229, 224,
        183, 72, 25, 6, 8, 210, 159, 31, 1,
    };

    private readonly Hash256 _keyNonce = (Hash256) new byte[]
    {
        121, 85, 7, 198, 131, 230, 143, 90, 165, 129, 173, 81, 186, 89, 19, 191, 13, 107, 197, 120, 243, 229, 224,
        183, 72, 25, 6, 8, 210, 159, 31, 2,
    };

    private readonly Hash256 _keyCodeCommitment = (Hash256)new byte[]
    {
        121, 85, 7, 198, 131, 230, 143, 90, 165, 129, 173, 81, 186, 89, 19, 191, 13, 107, 197, 120, 243, 229, 224,
        183, 72, 25, 6, 8, 210, 159, 31, 3,
    };

    private readonly Hash256 _keyCodeSize =(Hash256) new byte[]
    {
        121, 85, 7, 198, 131, 230, 143, 90, 165, 129, 173, 81, 186, 89, 19, 191, 13, 107, 197, 120, 243, 229, 224,
