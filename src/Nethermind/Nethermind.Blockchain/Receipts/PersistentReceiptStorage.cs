...
namespace Nethermind.Blockchain.Receipts
{
    public class PersistentReceiptStorage : IReceiptStorage
    {
        ...
        public bool HasBlock(BlockHeader block)
        {
            return block.ReceiptsRoot != Keccak.EmptyTreeHash
                ? _receiptsCache.Contains(block.Hash) || _blocksDb.KeyExists(block.Hash!)
                : LowestInsertedReceiptBlockNumber is null || block.Number >= LowestInsertedReceiptBlockNumber;
        }
