...
namespace Nethermind.Blockchain.Contracts
{
    public partial class Contract
    {
        ...
        protected interface IConstantContract
        {
            ...
            public (T1, T2, T3) Call<T1, T2, T3>(BlockHeader parentHeader, Address contractAddress, string functionName, Address sender, params object[] arguments) =>
                Call<T1, T2, T3>(new CallInfo(parentHeader, functionName, sender, arguments) { ContractAddress = contractAddress });
        }
