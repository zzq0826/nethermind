...
namespace Nethermind.Serialization.Rlp
{
    public class BlockDecoder : IRlpValueDecoder<Block>, IRlpStreamDecoder<Block>
    {
        ...
        private (int Total, int Txs, int Uncles, int? Withdrawals, int? ExecutionWitness) GetContentLength(Block item, RlpBehaviors rlpBehaviors)
        {
            ...
            return (contentLength, txLength, unclesLength, withdrawalsLength, wintessLength);
        }
        ...
        public void Encode(RlpStream stream, Block? item, RlpBehaviors rlpBehaviors = RlpBehaviors.None)
        {
            ...
            (int contentLength, int txsLength, int unclesLength, int? withdrawalsLength, int? witnessLength) = GetContentLength(item, rlpBehaviors);
