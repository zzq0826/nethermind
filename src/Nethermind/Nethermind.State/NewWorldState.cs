...
namespace Nethermind.State
{
    ...
    public class WorldState : PartialStorageProviderBase, IWorldState
    {
            ...
            : base(logManager)
        {
            ...
            _stateProvider = new WorldStateProvider(trieStore, codeDb, logManager);
        ...
        public new Snapshot TakeSnapshot(bool newTransactionStart = false)
        {
            return new Snapshot(_stateProvider.TakeSnapshot(newTransactionStart), ((IStorageProvider)this).TakeSnapshot(newTransactionStart));
        }
        ...
        public new void Commit(IStorageTracer stateTracer)
        {
            base.Commit(stateTracer);
        ...
        {
            Restore(snapshot.PersistentStorageSnapshot);
