...
namespace Nethermind.Evm.Test
{
    ...
    public class BnMulPrecompileTests
    {
        ...
        [Test]
        public void Test_using_shamatar()
        {
            byte[][] inputs =
            {
                Bytes.FromHexString("089142debb13c461f61523586a60732d8b69c5b38a3380a74da7b2961d867dbf2d5fc7bbc013c16d7945f190b232eacc25da675c0eb093fe6b9f1b4b4e107b36ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"),
            ...
            for (int i = 0; i < inputs.Length; i++)
            {
                Bn256MulPrecompile shamatar = (Bn256MulPrecompile)Precompiles.Snarks.Shamatar.Bn256MulPrecompile.Instance;
                (ReadOnlyMemory<byte>, bool) resultShamatar = shamatar.Run(inputs[i], MuirGlacier.Instance);
            }
        }

        [Test]
        public void Test_using_pairings()
        {
            byte[][] inputs =
            {
                Bytes.FromHexString("089142debb13c461f61523586a60732d8b69c5b38a3380a74da7b2961d867dbf2d5fc7bbc013c16d7945f190b232eacc25da675c0eb093fe6b9f1b4b4e107b36ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"),
