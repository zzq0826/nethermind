...
namespace Nethermind.Specs.ChainSpecStyle
{
    public class ChainSpecBasedSpecProvider : ISpecProvider
    {
        ...
        private void FillReleaseSpec(long releaseStartBlock, ulong releaseStartTimestamp, ReleaseSpec releaseSpec)
        {
            ...
            releaseSpec.Eip4844TransitionBlock = _chainSpec.Parameters.Eip4844Transition ?? long.MaxValue;
            ...
            releaseSpec.IsEip4844Enabled = (_chainSpec.Parameters.Eip4844Transition ?? long.MaxValue) <= releaseStartBlock;
