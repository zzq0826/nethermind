...
public class ListWithByteEqualityComparer : EqualityComparer<(List<byte>, byte)>
{
    ...
    {
        var isBytesSame =
            Bytes.SpanEqualityComparer.Equals(CollectionsMarshal.AsSpan(x.Item1), CollectionsMarshal.AsSpan(y.Item1));
    ...
    {
        return HashCode.Combine(Bytes.GetSimplifiedHashCode(CollectionsMarshal.AsSpan(obj.Item1)),
